...
set modelines=1
set ruler
set runtimepath=~/.vim,~/.vim/plugged/tagbar/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/indentLine/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/nerdtree/,~/.vim/plugged/syntastic/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/base16-vim/,~/.vim/plugged/vim-expand-region/,~/.vim/plugged/vim-polyglot/,~/.vim/plugged/vim-gitgutter/,~/.vim/plugged/ag.vim/,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/plugged/vim-polyglot/after,~/.vim/after
set shiftwidth=2
set showcmd
set showmatch
set showtabline=2
